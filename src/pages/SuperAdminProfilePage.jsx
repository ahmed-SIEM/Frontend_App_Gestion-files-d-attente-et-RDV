              ...
              >
                <Card className="p-6 text-center">
                  ...
                  <div className="relative inline-block mb-4">
                    <div className="w-32 h-32 bg-gradient-to-br from-purple-600 to-indigo-800 rounded-full flex items-center justify-center text-white text-4xl font-bold">
                  ...
                  <Badge className="bg-gradient-to-r from-purple-600 to-indigo-600 mb-4">
                    Super Admin
                  </Badge>
